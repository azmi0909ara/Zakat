// app/form/konfirmasi/KonfirmasiPembayaran.tsx
"use client";
...
const cloudName = "dd2rkqcjf"; // ganti sesuai Cloudinary kamu
const uploadPreset = "zakat_upload"; // ganti sesuai setting Cloudinary
          ...
          <>
            <div className="mb-4 space-y-2">
              ...
              <p>
                ...
                {uploadedUrl || data.bukti_transfer_url ? "lunas" : "belum"}
              </p>
